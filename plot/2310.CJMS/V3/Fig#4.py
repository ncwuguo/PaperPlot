...
# Plot the surfaces
ax.plot_surface(X, Y, profit_m_benchmark, color="#111111", shade=False)
ax.plot_surface(X, Y, profit_m_mainmodel, color="#888888", shade=False)
...
for x, text in zip(
    ...
    ax.text(x=x, y=72, z=642655.16, s=text, fontsize=20)

for y, text in zip(
    [100, 130, 160, 190, 220, 250],
    ["120", "150", "180", "210", "240", "270"],
):
    ax.text(x=0.44, y=y, z=642655.16, s=text, fontsize=20)
