...
quantity_mainmodel = Qg + qm + qs
quantity_benchamrk = Qa + qa
...
# Plot the surfaces
ax.plot_surface(X, Y, quantity_mainmodel, label="MainModel", color="#79B8DF")
ax.plot_surface(X, Y, quantity_benchamrk, label="Benchmark", color="#EDA8A8")
...
legend_labels = ["$q_m+q_s+Q_g$", "$q_a+Q_a$"]
