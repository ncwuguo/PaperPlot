...
# Plot the surfaces
ax.plot_surface(X, Y, profit_m_mainmodel, label="MainModel", color="#79B8DF", alpha=0.9)
ax.plot_surface(X, Y, profit_m_benchmark, label="Benchmark", color="#EDA8A8", alpha=0.9)
