...
ax.plot_surface(X, Y, Zg, label="单独储备", color="#79B8DF", alpha=0.9)
ax.plot_surface(X, Y, Zag, label="联合储备", color="#EDA8A8", alpha=0.9)
...
ax.legend(
    ...
    labels=legend_labels_3,
    fontsize=13,
    frameon=True,
    fancybox=False,
    shadow=True,
    edgecolor="black",
    bbox_to_anchor=(1.12, 0.93),
)
