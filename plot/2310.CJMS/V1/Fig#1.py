...
ax.plot_surface(X, Y, ZQ_c, label="联合储备", color="#EDA8A8", alpha=0.9)

ax.invert_xaxis()
ax.set_xlabel("$\\rho $", size=16)
ax.set_ylabel("$c_2$", size=16)
...
legend_labels_1 = ["$Q_a$", "$Q_c$"]
legend_labels_2 = ["$Q_a$", "$q_0+q_1+Q_a$"]
