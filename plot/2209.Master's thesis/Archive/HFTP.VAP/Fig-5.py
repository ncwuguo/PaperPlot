...
# generate canvas
fig, ax1 = plt.subplots(figsize=(4.2, 3), dpi=200)
...
ax1.set_xlabel("$b_{0} $", size=13)
ax1.set_ylabel("$b_{1} $", size=13)
ax1.tick_params(labelsize=13)

# annotate the plot with text
ax1.annotate(r"$\frac{\partial q_{m}}{\partial b_{0}}>0$", fontsize=16, xy=(0.59, 0.41))
ax1.annotate(r"$\frac{\partial q_{m}}{\partial b_{0}}<0$", fontsize=16, xy=(0.13, 0.71))
ax1.annotate("", xy=(0.47, 0.57), xytext=(0.59, 0.45), arrowprops=dict(arrowstyle="->"))
plt.annotate("0", xy=(0, 0), xytext=(-0.06, -0.05), size=13)
