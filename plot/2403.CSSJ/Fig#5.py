...
@Descrip  : Fig.5 Comparison of Supplier's Expected Profit under the Two Models
"""
...
# Calculate the values of supplier's expected profit under benchmark and mainmodel
